...
public struct ComponentBuilder {
    ...
    public mutating func parameter(
        id: String,
        builder: (() -> ParameterRepresentable)
    ) -> (id: ParameterID, value: ParameterRepresentable) {
...
//    mutating func getSchema(
//        id: String
//    ) throws(ComponentBuilderError) -> (id: SchemaID, value: SchemaRepresentable) {
